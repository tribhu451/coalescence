 ...
 */
  ...
  while (resonance_list.size() > 0) {
    ...
    if( Nbody_decay == 2 ){
      ...
      perform_two_body_decay( mother_pid,  mother_mass,
			      mother_width,mother_t,mother_x, mother_y,mother_z,
			      mother_e,  mother_px,  mother_py,  mother_pz,
			      daughter_1_mass, daughter_2_mass, daughter_1_pid, daughter_2_pid,
			      daughter1, daughter2) ;
...
void reso_decays::perform_two_body_decay(int mopid, double mom, double mow,
					 ...
					 double dt1m, double dt2m, int dt1pid, int dt2pid,
					 particles* daughter1, particles* daughter2) {
...
void reso_decays::perform_three_body_decay(int mopid, double mom, double mow,
					   double mot, double mox,  double moy,  double moz,
					   double moe, double mopx, double mopy, double mopz, 
					   double dt1m, double dt2m,  double dt3m ,int dt1pid,
					   int dt2pid, int dt3pid, particles* daughter1,
					   particles* daughter2, particles* daughter3 ) {
  double M_pole = mom;
  double M_width = mow;
  double m1 = dt1m ;
  double m2 = dt2m ;
